...
<div>
                ...
                <a class="navbar-brand" href="#"><b>가보자고</b></a>
                 <div class="search">
    				...
    				<form action="/search.jsp">
      				<input type="text" placeholder="Search.." name="search" class="no-border" style="border-radius:20px; height:40px; width:250px;">
      				<button type="submit" class="no-border" style="margin-left: -50px; "><i class="fa fa-search"></i></button>
    				</form>
  					</div>
    ...
    <main>
        <div class="container" style="width: 600px;">   
         ...
         <div class="container" >
         <img src="<c:url value="resoureces/images/img_internet_map.jpg"/>" style="width: 150px; height: 400px;">
         </div>
